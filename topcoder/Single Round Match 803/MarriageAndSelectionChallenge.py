...
def do_test(S, __expected):
    startTime = time.time()
    instance = MarriageAndSelectionChallenge()
    exception = None
    try:
...
def run_tests():
    sys.stdout.write("MarriageAndSelectionChallenge (500 Points)\n\n")
    ...
    with open("MarriageAndSelectionChallenge.sample", "r") as f:
        while True:
            label = f.readline()
